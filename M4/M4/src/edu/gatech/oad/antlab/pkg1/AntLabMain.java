 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Dhruv Saksena");
		  toPrint += p1.toString("902859678");
		  //Person2 replace P2 with your name
		  //and ggg000x with your gt num
		  Person2 p2 = new Person2("Eric Morphis");
		  toPrint += p2.toString("902466252");
		  //Person3 replace P3 with your name
		  //and ggg000x with your gt num
		  Person3 p3 = new Person3("Rikin Marfatia");
		  toPrint += p3.toString("902825262");
          //Person4 replace P4 with your name
          //and ggg000x with your gt num
          Person4 p4 = new Person4("Eric Peyton");
          toPrint += p4.toString("902705905");
		  //Person5 replace P5 with your name
          //and ggg000x with your gt num
          Person5 p5 = new Person5("Eric Slep");
          toPrint += p5.toString("902814069");
